 ...
 */
public class CIInquiryRedeemRecordWSModelTest extends SBaseAndroidTestCase {
    /**
     * 功能：查詢哩程兌換資料。向API請求資料後，依據結果調用正確之callback。
     */
    ...
    /**
     * 案例說明：有網路狀態，傳入正確的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程兌換資料成功
     * 輸入參數：m_reqMileage
    ...
    public void testCase01() throws Exception {
        ...
        CIInquiryRedeemRecordModel model = new CIInquiryRedeemRecordModel(
                new CIInquiryRedeemRecordModel.InquiryRedeemRecordCallBack() {
                    @Override
                    public void onInquiryRedeemRecordSuccess(String rt_code,
                        ...
                        Assert.assertNotNull( redeemRecordResp );
    ...
    /**
     * 案例說明：無網路狀態，傳入正確的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程兌換資料失敗
     * 輸入參數：m_reqMileage
    ...
    /**
     * 案例說明：有網路狀態，傳入錯誤的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程兌換資料失敗
