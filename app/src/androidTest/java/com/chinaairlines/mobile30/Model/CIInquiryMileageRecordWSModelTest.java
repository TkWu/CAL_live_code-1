...
/**
 * Created by jlchen on 2016/8/26.
 */
public class CIInquiryMileageRecordWSModelTest extends SBaseAndroidTestCase {
    /**
     * 功能：查詢哩程明細資料。向API請求資料後，依據結果調用正確之callback。
     */
    ...
    /**
     * 案例說明：有網路狀態，傳入正確的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程明細資料成功
     * 輸入參數：m_reqMileage
    ...
    public void testCase01() throws Exception {
        ...
        CIInquiryMileageRecordModel model = new CIInquiryMileageRecordModel(
                new CIInquiryMileageRecordModel.InquiryMileageRecordCallBack() {
                    @Override
                    public void onInquiryMileageRecordSuccess(String rt_code,
                        ...
                        Assert.assertNotNull( mileageRecordResp );
    ...
    /**
     * 案例說明：無網路狀態，傳入正確的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程明細資料失敗
     * 輸入參數：m_reqMileage
    ...
    /**
     * 案例說明：有網路狀態，傳入錯誤的參數，使用setMileageReq()和DoConnection()向WS請求查詢哩程明細資料失敗
