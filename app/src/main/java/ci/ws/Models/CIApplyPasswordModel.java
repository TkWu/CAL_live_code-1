 ...
 */
public class CIApplyPasswordModel extends CIWSBaseModel{

    public interface ApplyPasswordCallback {
        /**
         * 成功由此訊息通知,
         * rt_code 規則同api文件
         *
    ...
    private ApplyPasswordCallback m_callback = null;
    private static final String API_NAME = "/CIAPP/api/ApplyPassword";
     ...
     * */
    public CIApplyPasswordModel(String card_no, String first_name, String last_name, String birth_date, String strLanguage, String strDevice_id, String strVersion, ApplyPasswordCallback listener){
    ...
    protected void DecodeResponse_Success(CIWSResult respBody, String code) {
        ...
        if ( null != m_callback ){
            m_callback.onApplyPasswordSuccess(respBody.rt_code, respBody.rt_msg, strEmail);
        }
    }
    ...
    protected void DecodeResponse_Error(String code, String strMag, Exception exception) {
        if ( null != m_callback ){
            m_callback.onApplyPasswordError( code , strMag);
        }
    }
}
