 ...
 * 功能說明：加購行李付款。
 */
public class CIEBPaymentModel extends CIWSBaseModel {
    ...
    private static final String API_NAME = "/CIAPP/api/EBPayment";
    ...
    public CIEBPaymentModel(InquiryCallback callback){

        this.m_Callback = callback;
    }

    public void getInfoFrowWS(CIEBPaymentReq req){
        ...
        try {
            ...
            m_jsBody.put(eParaTag.Token.getString(), req.token);
    ...
    protected void DecodeResponse_Success(CIWSResult respBody, String code){
        ...
        CIEBPaymentResp data
                = GsonTool
                .getGson()
                .fromJson(respBody.strData, CIEBPaymentResp.class);
    ...
    protected void DecodeResponse_Error(String code, String strMag, Exception exception) {
        if ( WSConfig.WS_TESTMODE ){
            DecodeResponse_Success( ResultCodeCheck(getJsonFile(WSConfig.EBPayment)) ,"");
        } else {
            if (null != m_Callback) {
