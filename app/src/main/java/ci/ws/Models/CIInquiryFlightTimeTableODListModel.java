...
import ci.ws.Models.entities.CIFlightStationTimeTableODList;
 ...
 * 功能說明: 取得出發地、目的地清單。
 */
public class CIInquiryFlightTimeTableODListModel extends CIWSBaseModel{
    ...
    private RuntimeExceptionDao<CIFlightStationTimeTableODEntity, Integer> m_dao
            = CIApplication.getDbManager().getRuntimeExceptionDao(CIFlightStationTimeTableODEntity.class);
    ...
    public CIInquiryFlightTimeTableODListModel(StationCallBack callback){
        m_callback = callback;
    ...
    public void getFromWS(){
        ...
        try {
            ...
            m_jsBody.put( eParaTag.last_update_date.name(), modelInfo.GetTimeTableODLastUpdateDate());
    ...
    protected void DecodeResponse_Success(CIWSResult respBody, String code) {
        ...
        CIFlightStationTimeTableODList List = new CIFlightStationTimeTableODList();
        try {
        ...
        synchronized (s_lock){
            ...
            modelInfo.SetTimeTableODLastUpdateDate(date);
    ...
    private CIFlightStationTimeTableODList paserJsonData(JSONArray jsArrayList) throws Exception{
        CIFlightStationTimeTableODList list = new CIFlightStationTimeTableODList();
        ...
        for ( int iIdx=0; iIdx < ilength; iIdx++ ){
            ...
            if ( null != jsObj ){
                ...
                for ( int iJdx = 0; iJdx<iArrlength; iJdx++ ){
                    ...
                    CIFlightStationTimeTableODEntity data = new CIFlightStationTimeTableODEntity();
    ...
    protected void DecodeResponse_Error(String code, String strMag, Exception exception) {
        ...
        if ( WSConfig.WS_TESTMODE ){
            DecodeResponse_Success( ResultCodeCheck(getJsonFile(WSConfig.InquiryTimeTableOD)) ,"");
    ...
    public void Clear(){
        try {
            TableUtils.clearTable(m_connectionSource, CIFlightStationTimeTableODEntity.class);
    ...
    public void initLastUpdateDate(){
        modelInfo.SetTimeTableODLastUpdateDate(CIModelInfo.DEF_LAST_UPDATE_DATE);
    }

    private void CreateTable(){
        try {
            TableUtils.createTable(m_connectionSource, CIFlightStationTimeTableODEntity.class);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    private boolean insert(ArrayList<CIFlightStationTimeTableODEntity> datas ) {
        try {
            m_dao.create(datas);
        }catch (Exception e){
    ...
    public List<CIFlightStationEntity> getArrivalSrtationByDepartureAndKeyWord(String strStationCode,
        ...
        try {
            QueryBuilder<CIFlightStationTimeTableODEntity,Integer> ODBuilder = m_dao.queryBuilder();
