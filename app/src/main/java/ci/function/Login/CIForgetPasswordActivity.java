...
import static ci.function.Login.CIForgetPasswordFragment.onForgetPasswordListener;
...
public class CIForgetPasswordActivity extends BaseActivity{
    ...
    private onNavigationbarParameter m_onNavigationParameter = new onNavigationbarParameter() {
        ...
        public String GetTitle() {
            return m_Context.getString(R.string.inquiry_password_title);
        }
    };
    ...
    private onForgetPasswordListener m_onForgetPasswordListener = new onForgetPasswordListener() {
        @Override
...
//                strBirthDay = AppInfo.getInstance(m_Context).ConvertDateFormat(strBirthDay);
            ...
            m_inquiryPresenter.InquiryPasswordFromWS( strCardNo, strFirstName, strLastName, strBirthDay );
        }
    };
        ...
        public void showProgress() {
            ...
            showProgressDialog(new CIProgressDialog.CIProgressDlgListener() {
                ...
                public void onBackPressed() {
                    ...
                    m_inquiryPresenter.InquiryPasswordCancel();
                }
            });
        }
    ...
    protected void registerFragment(FragmentManager fragmentManager) {
        CIForgetPasswordFragment ForgetPasswordFragment = new CIForgetPasswordFragment();
        ForgetPasswordFragment.uiSetParameterListener(m_onForgetPasswordListener);
        ChangeFragment(ForgetPasswordFragment);
    }
