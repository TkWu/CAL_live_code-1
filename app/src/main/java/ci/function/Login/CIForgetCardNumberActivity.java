...
import static ci.function.Login.CIForgetCardNumberFragment.onForgetCardNumberListener;
 ...
 */
public class CIForgetCardNumberActivity extends BaseActivity {
    ...
    private onNavigationbarParameter m_onNavigationParameter = new onNavigationbarParameter() {
        ...
        public String GetTitle() {
            return m_Context.getString(R.string.inquiry_card_number_title);
        }
    };
    ...
    private onNavigationbarListener m_onNavigationbarListener = new onNavigationbarListener() {
        ...
        public void onBackClick() {
            CIForgetCardNumberActivity.this.finish();
        }
    ...
    private onForgetSuccessParameter m_onForgetSuccessParameter = new onForgetSuccessParameter() {
        ...
        public String GetForgetSuccessMsg() {
            return getString(R.string.inquiry_card_number_inquiry_successfully);
        }
    ...
    private onForgetCardNumberListener m_onForgetCardNumberListener = new onForgetCardNumberListener() {
        @Override
        public void onSendClick(String strFirstName, String strLastName, String strBirthDay) {

//            if ( 0 < strBirthDay.length() )
//                strBirthDay = AppInfo.getInstance(m_Context).ConvertDateFormat(strBirthDay);

            m_inquiryPresenter.InquiryCardNoFromWS( strFirstName, strLastName, strBirthDay );
        }
    };
    ...
    private CIInquiryListener m_InquiryListener = new CIInquiryListener() {
        ...
        @Override
        public void onApplyPasswordError(String rt_code, String rt_msg) {}
        ...
        public void showProgress() {
            ...
            showProgressDialog(new CIProgressDialog.CIProgressDlgListener() {
                ...
                public void onBackPressed() {
                    ...
                    m_inquiryPresenter.InquiryCardNoCancel();
                }
            });
        }
    ...
    protected void registerFragment(FragmentManager fragmentManager) {
        CIForgetCardNumberFragment ForgetCardNumberFragment = new CIForgetCardNumberFragment();
        ForgetCardNumberFragment.uiSetParameterListener(m_onForgetCardNumberListener);
        ChangeFragment(ForgetCardNumberFragment);
    }
